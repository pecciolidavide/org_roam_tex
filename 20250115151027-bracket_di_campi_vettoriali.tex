...
\date{\today}
\title{Bracket di campi vettoriali}
\begin{document}
...
\end{equation*}
\section{{\bfseries\sffamily TODO} Il bracket è realmente un campo vettoriale\hfill{}\textsc{matematica\_lm:geo\_diff}}
\label{sec:org680282d}

\section{Proprietà}
\label{sec:org4fc96c6}
