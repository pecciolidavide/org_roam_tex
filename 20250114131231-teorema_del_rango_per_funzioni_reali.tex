...
\date{\today}
\title{Teorema del rango per funzioni reali}
\begin{document}

\section{Teorema}
\label{sec:org9ebc131}
...
\label{sec:orgb361217}
Questo teorema implica il \href{20250113125429-teorema_dell_inversa_locale.org}{TIV}.
\subsection{{\bfseries\sffamily TODO} Dimostazione\hfill{}\textsc{matematica\_lm:geo\_diff}}
\label{sec:orgea2ef80}
\end{document}
