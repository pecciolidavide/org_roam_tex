...
\item per ogni \(p \in X\): \(\varphi_{p}:\mathcal{F}_{p}\to \mathcal{G}_{p}\)\textsuperscript{\ref{orge41ea07}} è un \href{20241206115531-morfismo_di_gruppi.org}{morfismo di gruppi} \href{20241213105600-funzione_suriettiva.org}{suriettivo}.
\end{enumerate}
\end{prop}
