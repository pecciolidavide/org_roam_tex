...
\subsection{Funzione}
\label{sec:org7ce78bf}

\subsubsection{Relazione Funzionale MK}
\label{sec:orgf1a1524}
...
\label{sec:org2404574}
Se \(F\) è una \hyperref[sec:orgf1a1524]{Classe-Funzione} \href{20241219101956-funzione_iniettiva.org}{iniettiva}, allora \(\breve{F}\) è una Classe-Funzione, denotata con \(F^{-1}\). Si dice che \(F\) è \uline{invertibile}. Vale che, per ogni elemento del \href{20250202173528-dominio_range_e_campo_di_una_classe_relazione.org}{dominio}, la \hyperref[sec:orge3c9e71]{composizione} è l'identità:
\begin{equation*}
