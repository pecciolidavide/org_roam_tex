...
\date{\today}
\title{Successione delle distanze tende a zero implica successioni hanno lo stesso limite}
\begin{document}

\section{Teorema}
\label{sec:orga8cb27f}
...
\end{equation*}
\subsubsection{Limiti uguali \%\% Dimostrazione alternativa}
\label{sec:orge8d3713}
Siano quindi
\begin{equation*}
