...
\section{Numeri naturali sono cardinali}
\label{sec:org212d83a}
...
\section{Proprietà dei cardinali}
\label{sec:org4ca7f08}
Se \(\kappa, \lambda\) sono \href{20250203161341-cardinali.org}{cardinali}, allora
\begin{enumerate}
...
\end{enumerate}
\section{Estremo superiore di un insieme  di cardinali è un cardinale}
\label{sec:orge98e162}
Sia \(X\) un \href{20250130104331-insieme_mk.org}{insieme} di \href{20250203161341-cardinali.org}{cardinali}. Allora \(\operatorname{sup}(X)\) è un \href{20250203161341-cardinali.org}{cardinale} (vedi \href{20250203111003-ordinali.org}{Relazione d'ordine sugli ordinali} e \href{20250203102516-massimo_e_minimo.org}{Infimum e supremum})
\subsection{Dimostrazione}
\label{sec:org275f9eb}
