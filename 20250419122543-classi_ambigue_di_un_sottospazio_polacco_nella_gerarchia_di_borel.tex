...
\date{\today}
\title{Classi ambigue di un sottospazio polacco nella gerarchia di Borel}
\begin{document}

\section{Proposizione}
\label{sec:org79153ef}
