...
\date{\today}
\title{Estensione finita di una teoria decidibile è decidibile}
\begin{document}
...
\subsection{Idea di dimostrazione}
\label{sec:org13fe275}
