...
\date{\today}
\title{Funzioni ricorsive e loro grafico}
\begin{document}
...
\section{Grafico di una funzione ricorsiva totale è ricorsivo}
\label{sec:org0684849}
\begin{enumerate}
...
\end{enumerate}
\section{Funzioni parziali con grafico semiricorsivo sono ricorsive}
\label{sec:org0781444}
...
\end{enumerate}
\section{Grafico di una funzione ricorsiva parziale è semiricorsivo}
\label{sec:org081094a}
...
\section{Funzione ricorsiva sse il suo grafico è semiricorsivo}
\label{sec:org4a49289}
...
\section{Caratterizzazione funzioni ricorsive tramite grafico}
\label{sec:org30afebb}
