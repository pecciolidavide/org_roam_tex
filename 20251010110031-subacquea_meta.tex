...
\section{Gestione immersione}
\label{sec:org07202b3}
...
\end{itemize}
\section{Nuoto in superficie - Descrizione}
\label{sec:org9ae2278}
...
\end{itemize}
\section{Nuoto in superficie - Tecniche componenti}
\label{sec:orgcb8a8cc}
...
\end{enumerate}
\section{Apnea dinamica senza attrezzi - Descrizione}
\label{sec:org3ed871d}
...
\end{itemize}
\section{Apena dinamica senza attrezzi - Tecniche componenti}
\label{sec:orga388bc8}
...
\end{enumerate}
\section{Salvamento di un apneista incosciente sul fondo - Descrizione}
\label{sec:org466fee2}
...
\end{itemize}
\section{Salvamento di un apneista incosciente sul fondo - Tecniche componenti}
\label{sec:org7639886}
...
\item Primo soccorso
\end{enumerate}
\section{Capovolte in raccolta - Descrizione}
\label{sec:org527367f}
...
\section{Capovolte in raccolta - Tecniche componenti}
\label{sec:orgb79dc07}
...
\end{enumerate}
\section{Equipaggiamento sul fondo - Descrizione}
\label{sec:orgb17ae9e}
...
\end{itemize}
\section{Equipaggiamento sul fondo - Tecniche componenti}
\label{sec:orgd3ed7bf}
...
\item Tranquillità
\end{enumerate}
\section{Capovolte con attrezzatura - Descrizione}
\label{sec:orge830024}
...
\end{itemize}
\section{Capovolte con attrezzatura - Tecniche componenti}
\label{sec:org9ee849f}
