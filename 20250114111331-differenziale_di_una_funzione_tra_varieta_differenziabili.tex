...
\date{\today}
\title{Differenziale di una funzione tra varietà differenziabili}
\begin{document}
...
\label{sec:orgee46fe1}
\section{{\bfseries\sffamily TODO} Osservazione\hfill{}\textsc{matematica\_lm:geo\_diff}}
\label{sec:org2f77490}
