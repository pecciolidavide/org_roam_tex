...
\date{\today}
\title{Teorema: Proiezione su un iperpiano di una varietà è varietà}
\begin{document}
...
\label{sec:org94dba5c}

\paragraph{Implicazione ->}
\label{sec:org2e021ec}
