...
\section{Topologia indotta da un atlante}
\label{sec:org61aff03}
...
\end{equation*}
è un aperto in \(\R^{n}\).
\subsection{{\bfseries\sffamily TODO} Dimostrazione che questo induce una topologia\hfill{}\textsc{matematica\_lm:geo\_diff}}
\label{sec:org470c599}
\end{document}
