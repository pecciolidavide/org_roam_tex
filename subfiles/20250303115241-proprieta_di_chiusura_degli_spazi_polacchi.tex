...
Osserviamo\footnote{Sarebbe da dimostrare questa continuità\label{orgda77937}} che \(d(\cdot, F): X\to [0,1]\) è una funzione \href{20250103103252-funzione_continua.org}{continua}.
...
Per \href{20250103103252-funzione_continua.org}{continuità}\textsuperscript{\ref{orgda77937}} di \(d(\cdot, F)\) (vedi \href{20250304142114-funzione_continua_e_continua_per_successioni.org}{Funzione continua è continua per successioni})
\begin{equation*}
d(y_{i}, F)\to d(y,F)
\end{equation*}
