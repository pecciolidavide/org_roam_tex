...
\begin{equation*}
\operatorname{sd}^{m}(\iota)=\sum a_{i}\uptau_{i}
\end{equation*}
con \(\uptau_{i}\) \href{20250129094132-trasformazione_affine.org}{trasformazioni affini}. In particolare, quindi, si ha che
\begin{equation*}
\operatorname{diam}\operatorname{Im}\uptau_{i} < \lambda %
\IMPLICA %
\operatorname{Im}\uptau_{i} \subseteq U_{1}\ %
\text{ o }\ %
\operatorname{Im}\uptau_{i} \subseteq U_{2}.
\end{equation*}
Calcolando adesso \(\operatorname{sd}^{m}_{q}(\sigma)\):
\begin{equation*}
\operatorname{sd}^{m}_{q}(\sigma) = \sigma_{\diesis} \, \operatorname{sd}^{m}(\iota) = \sum a_{i}\, \sigma\circ\uptau_{i}
\end{equation*}
e ogni \(\operatorname{Im}(\sigma\circ\uptau_{i}) \subseteq \mathring{X}_{1}\) oppure \(\operatorname{Im}(\sigma\circ\uptau_{i}) \subseteq \mathring{X}_{2}\).

Pertanto, per ogni \(i\), \(\sigma \circ \uptau_{i} \in \Sigma_{q}(\mathring{X}_{1})\) oppure \(\sigma \circ \uptau_{i} \in \Sigma_{q}(\mathring{X}_{2})\), e quindi, per definizione di \href{20241206142802-sottomoduli.org}{somma di moduli}:
\begin{equation*}
