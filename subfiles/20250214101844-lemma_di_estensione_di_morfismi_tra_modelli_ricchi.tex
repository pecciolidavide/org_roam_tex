...
\section{Lemma di estensione di morfismi tra modelli ricchi}
\label{sec:orga581e16}
...
\subsection{Modelli ricchi della stessa cardinalità se nella stessa componente connessa sono isomorfi}
