...
Restringendo \(\Phi\upharpoonright\operatorname{Hrtg}(X)\)\footnote{Con \(\operatorname{Hrtg}\) si intende il \href{20250205152531-numeri_di_hartogs.org}{Numero di Hartogs}.}, si ottiene un \href{20241219101956-funzione_iniettiva.org}{iniezione} \(\operatorname{Hrtg}(X)\to X\). Assurdo.
\end{proof}
\begin{cor}
