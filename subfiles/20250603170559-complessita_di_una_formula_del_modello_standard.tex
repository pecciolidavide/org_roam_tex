...
\section{Complessità di una formula nel linguaggio dell'aritmetica}
\label{sec:org1b4e7d4}
...
\end{itemize}
\subsubsection{Quantificatore limitato nel linguaggio dell'aritmetica}
...
\end{enumerate}
\subsection{Descrizione esplicita}
