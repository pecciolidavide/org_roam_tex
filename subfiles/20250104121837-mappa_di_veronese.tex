...
\section{Mappa di Veronese}
\label{sec:org70c7a37}
...
\begin{enumerate}
\item Claim: esiste \(\ell_{0}\) tale \(P_{K_{\ell_{0}}}\neq 0\)
...
\item {\bfseries\sffamily TODO} \(P \in V_{n,d}\)\hfill{}\textsc{matematica\_lm:geo\_alg}
