...
\def\Z{\mathcal{Z}}
\def\V{\mathcal{V}}
\section{Teoria dei modelli [CORSO]}
\label{sec:orga4c44e6}
\maketitle
\textbf{\textbf{NOTAZIONE IMPORTANTE}}: Tutte le mappe sono parziali, se non diversamente indicato.

Le dispense di questo corso sono 
\subsection{Istruzioni Esame}
\label{sec:org89d6e51}
...
\end{itemize}
\subsection{Lezione 1 - \textit{<2025-09-23 Mar>}}
\label{sec:org4edeeb7}

\subsubsection{Ripasso}
\label{sec:org6a433c6}

\paragraph{Saturazione e omogeneità}
\label{sec:orgab7a8e9}
...
\end{enumerate}
\end{prop}
\paragraph{\(\mathcal{U}\) come spazio topologico}
\label{sec:org6c5b9d9}
...
\end{oss}
\paragraph{Definibilità e Automorfismi}
\label{sec:orgd8473b1}
...
\paragraph{Definibilità e invarianza}
\label{sec:org14230aa}
...
\end{enumerate}
\end{thm}
\subsubsection{Preservation Theorem}
\label{sec:orgcc4fa82}
...
\end{align*}
\end{proof}
\subsection{Lezione 2 - \textit{<2025-09-24 Mer>}}
\label{sec:orgff4ab4a}

\subsubsection{Preservation Theorem}
\label{sec:org82f3221}
...
\end{proof}
\subsubsection{Back-and-forth conditions for QE}
\label{sec:org64c60c2}
...
\end{enumerate}
\end{prop}
\subsubsection{Model-completeness}
\label{sec:org30a1e5a}
...
\subsection{Lezione 3 - \textit{<2025-09-30 Mar>}}
\label{sec:orgcd82cff}
...
\uline{Esercizio di meditazione}: Leggere la dimostrazione del Teorema di Kuratowski-Ulam\footnote{Vedi per una dimostrazione.} e convincersi che in fondo è il Lemma~\ref{lem:kurulma}
...
\end{enumerate}
\subsection{Lezione 4 - \textit{<2025-10-01 Mer>}}
\label{sec:org3613b18}
...
\item \(\card{p(x)}<\kappa\) (ovvero i tipi sono piccoli).
\end{itemize}
\subsubsection{Modelli primi e modelli atomici}
\label{sec:org02f8ab7}
...
\end{cor}
\subsubsection{Categoricità numerabile}
\label{sec:orgda8b082}
...
\subsection{Lezione 5 - \textit{<2025-10-07 Mar>}}
\label{sec:org92d4adf}
...
\end{proof}
\subsubsection{Teorie sottili (\emph{small})}
\label{sec:org5b5f83d}
...
\end{proof}
\subsection{Lezione 6 - \textit{<2025-10-08 Mer>}}
\label{sec:org1408c71}
...
\end{esempio}
\subsubsection{Linguaggio a più sorte}
\label{sec:orge9ac635}
...
\end{oss}
\subsubsection{Linguaggio del secondo ordine}
\label{sec:org964c252}

???
\subsubsection{Immaginari}
\label{sec:org6494ab3}
...
\end{esempio}
\subsection{Lezione 7 - \textit{<2025-10-14 Mar>}}
\label{sec:org3e69b91}
...
\end{oss}
\subsubsection{Sottostrutture elementari}
\label{sec:org19b550a}
...
\subsection{Lezione 8 - \textit{<2025-10-15 Mer>}}
\label{sec:org5a7724d}

\subsubsection{Eliminazione degli immaginari}
\label{sec:org99eac09}
...
\end{proof}
\subsection{{\bfseries\sffamily TODO} Lezione 9 - \textit{<2025-10-21 Mar>}}
\label{sec:orgab24d03}

\subsubsection{Formule e tipi invarianti}
\label{sec:orgffa02a5}
...
\end{definizione}
\begin{itemize}
\item[{$\square$}] \href{20251113175327-insieme_esternamente_definibile_in_un_modello_mostro.org}{Insieme esternamente definibile} vedi p.118 di
\end{itemize}
...
\end{equation*}
\paragraph{Eredi e coeredi}
\label{sec:org7450f75}
...
\end{cor}
\subsection{{\bfseries\sffamily DONE} Lezione 10 - \textit{<2025-10-22 Mer>}}
\label{sec:org7ea4413}

\subsubsection{{\bfseries\sffamily DONE} \href{20251026210840-sequenza_di_morley.org}{Sequenze di Morley}}
\label{sec:orgbc4169b}
...
\end{equation*}
\end{definizione}
\subsubsection{Sequenze di indiscernibili}
\label{sec:orge72a685}
...
La risposta è NO!! See Remark~14.7 e Esercizio~14.13 di .
\subsection{{\bfseries\sffamily DONE} Lezione 11 - \textit{<2025-10-28 Mar>}}
\label{sec:org11a7b2f}
...
\end{proof}
\subsubsection{Teorema di Ramsey}
\label{sec:orgcf7853c}

Vedi Sezione 15.1 di .

\href{20251029171516-teorema_di_ramsey.org}{Teorema di Ramsey}
\subsection{{\bfseries\sffamily DONE} Lezione 12 - \textit{<2025-10-29 Mer>}}
\label{sec:orgf61283a}

\subsubsection{Teorema di Ehrenfeucht-Mostowski}
\label{sec:org410b8d5}
...
\end{proof}
\subsubsection{Teorema di Hindman}
\label{sec:org8c95747}
...
\end{oss}
\subsection{{\bfseries\sffamily TODO} Lezione 13 - \textit{<2025-11-04 Mar>}}
\label{sec:org4123b79}

\subsubsection{Topological dynamics}
\label{sec:org2770e4d}
...
\end{proof}
\subsection{{\bfseries\sffamily TODO} Lezione 14 - \textit{<2025-11-05 Mer>}}
\label{sec:org21e091b}
...
\end{oss}
\subsection{{\bfseries\sffamily DONE} Lezione 15 - \textit{<2025-11-11 Mar>}}
\label{sec:org0ea30a2}
\def\D{\mathcal{D}}
\def\DD{\bm{\D}}
\def\U{\mathcal{U}}
\def\eq{{\rm eq}}
...
\end{equation*}
\subsection{{\bfseries\sffamily DONE} Lezione 16 - \textit{<2025-11-12 Mer>}}
\label{sec:org724efef}
...
\renewcommand{\nonfork}[1][\defaultnonforkmodel]{%
\mathrel{\nonforkSymbol_{#1}}}
\subsubsection{Relazioni stabili}
\label{sec:orgb2b1499}
...
\end{proof}
\subsection{{\bfseries\sffamily TODO} Lezione 17 - \textit{<2025-11-18 Mar>}}
\label{sec:orgabbdca8}
...
\end{proof}
\subsection{{\bfseries\sffamily TODO} Lezione 18 - \textit{<2025-11-25 Mar>}}
\label{sec:org29cf9c3}
...
\subsubsection{Lascar invariance}
\label{sec:org339151c}
...
\end{esempio}
\subsection{{\bfseries\sffamily TODO} Lezione 19 - \textit{<2025-11-26 Mer>}}
\label{sec:org2807144}
...
\end{proof}
\subsection{{\bfseries\sffamily TODO} Lezione 20 - \textit{<2025-12-02 Mar>}}
\label{sec:org595ab47}
...
\begin{thm}
(\(T\) stabile).
Ogni \(q(x) \in S(\acl^{\eq} A)\)\footnote{\(q(x)\) è un tipo completo a parametri in \(S(\acl^{\eq} A)\).\label{org956b5b3}} è stazionario su \(A\).
...
\uline{Esercizio}:
(\(T\) stabile).
Ogni \(q(x) \in S(M)\)\textsuperscript{\ref{org956b5b3}} è stazionario su \(M\).
...
\subsection{{\bfseries\sffamily TODO} Lezione 21 - \textit{<2025-12-03 Mer>}}
\label{sec:orgf662719}
...
\end{equation*}
\end{proof}
\subsection{Lezione 22 - \textit{<2025-12-09 Mar>}}
\label{sec:org2c5ab32}
...
\end{proof}
\subsection{Lezione 23 (Ultima) - \textit{<2025-12-16 Mar>}}
\label{sec:orgaa630dd}
...
\end{equation*}
\end{oss}
\subsection{INFO ESAME}
\label{sec:org3035cac}
