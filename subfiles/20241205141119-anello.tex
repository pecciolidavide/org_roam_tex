...
\begin{itemize}
\item \(\Z,\Q,\R,\C,\Z_{n}, A[X]\)\footnote{Vedi ``\href{20250103103252-funzione_continua.org}{Funzione Continua}''.\label{org2863473}};
...
\item \(C(X, \R)\coloneqq\set{f:X\to \R\text{ continua}}\)\textsuperscript{\ref{org2863473}} per \(X\) \href{20250103145124-topologia.org}{spazio topologico}; sottoanello di \(F(X,\R)\).
\end{itemize}
\end{esempio}
