...
\section{Proprietà di base dell'ordine sugli ordinali}
\label{sec:orga8606d8}
...
\end{enumerate}
\end{enumerate}
\subsubsection{{\bfseries\sffamily TODO} Dimostrazione\hfill{}\textsc{IdL:matematica\_lm}}
...
\paragraph{{\bfseries\sffamily TODO} Punto g.\hfill{}\textsc{IdL:matematica\_lm}}
...
\end{equation*}
\paragraph{{\bfseries\sffamily TODO} Punto h.\hfill{}\textsc{IdL:matematica\_lm}}
