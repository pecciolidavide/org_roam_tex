...
\section{Caratterizzazione dei sigma-compatti nello spazio di Baire}
\label{sec:org82bc3cb}
...
\end{align*}
\paragraph{Caratterizzazione dei \(\sigma\)-compatti}
...
\paragraph{Insieme \(\sigma\)-compatto ma non compatto}
...
\paragraph{Immersione di \(\omega^{\omega}\)}
