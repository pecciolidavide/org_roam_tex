...
\section{Metodi Matematici per il Machine Learning [CORSO]}
\label{sec:org5094f74}
...
\subsection{Introduzione (De Rossi)}
\label{sec:org97001c8}
...
\end{itemize}
\subsection{Analisi Matematica (Cordero)}
\label{sec:org088c536}
...
\end{itemize}
\subsection{Cordero}
\label{sec:org11e3e0a}

\subsubsection{Lezione 1}
\label{sec:orgef92d5d}
...
\label{sec:org9bcaa29}

\begin{itemize}
\item \href{20250713215224-backpropagation_per_una_rete_neurale.org}{Backpropagation per una rete neurale}
\end{itemize}
\subsubsection{Lezione 8}
\label{sec:orgcb63a14}
