...
\Sigma_{n}(\Delta_{q})\ni\uptau &\longmapsto \sigma\circ\uptau
\end{aligned}
}
\end{equation*}
...
\begin{equation*}
 \operatorname{sd}_{q}(\iota_{q}) = \sum a_{i}\ \uptau_{i}
\end{equation*}
con \(\uptau_{i} \in \Sigma_{q}(\Delta_{q})\) \href{20250129094132-trasformazione_affine.org}{trasformazioni affini}.
\item Se \(\uptau_{0}: \Delta_{q} \longrightarrow\Delta_{q}\) è una \href{20250129094132-trasformazione_affine.org}{trasformazione affine}, allora
\begin{align*}
 \operatorname{sd}_{q}(\uptau_{0}) &= (\uptau_{0})^{q}_{\diesis}\ \operatorname{sd}_{q}(\iota_{q})\\
 &= (\uptau_{0})^{q}_{\diesis}\ \sum a_{i}\ \uptau_{i} = \sum a_{i}\ \uptau_{0}\circ \uptau_{i}
\end{align*}
dove, ovviamente, \(\uptau_{0}\circ\uptau_{i}\) è ancora una \href{20250129094132-trasformazione_affine.org}{trasformazione affine}.

Pertanto, si ha che \(\operatorname{sd}_{q}^{2}(\iota_{q}) = \sum a_{j}a_{h}\ \uptau_{i}\circ\uptau_{j}\) è ancora somma di \href{20250129094132-trasformazione_affine.org}{trasformazioni affini}.
\item Se \(\uptau:\Delta_{q}\to \Delta_{q}\) \href{20250129094132-trasformazione_affine.org}{trasformazione affine}, con \(P_{i} \coloneqq \uptau(e_{i})\)\footnote{Con \(e_{i}\) si indicano \href{20250121122324-simplesso_standard.org}{i punti base di \(\Delta_{q}\)}}, allora \(\operatorname{sd}_{q}\uptau = \sum_{i} a_{i}\uptau_{i}\), dove \(\uptau_{i}\) affine e tale che:
\begin{align*}
\uptau_{i}: \Delta_{q} &\longrightarrow \Delta_{q}\\
