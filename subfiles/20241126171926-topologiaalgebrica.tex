...
\section{Topologia Algebrica [CORSO]}
\label{sec:org7fbfa12}
...
\begin{itemize}
\item[{$\boxtimes$}] \href{20260205151208-attaccamento_di_una_k_cella_a_uno_spazio_topologico.org}{Attaccamento di una k-cella a uno spazio topologico}
...
\end{itemize}
\subsection{Lezione 17 [57\%]}
\label{sec:org6460283}

\begin{itemize}
\item[{$\boxtimes$}] \href{20260209153646-sistema_diretto.org}{Sistema diretto}
\item[{$\boxtimes$}] \href{20260209153646-sistema_diretto.org}{Limite diretto}
\item[{$\boxtimes$}] \href{20260209163309-funtore_covariante_applicato_ad_un_sistema_diretto.org}{Funtore covariante applicato ad un sistema diretto}
\item[{$\square$}] \href{20260209161309-omologia_singolare_di_cw_complessi_come_limite_diretto.org}{Omologia singolare di CW-complessi come limite diretto}
\item[{$\boxtimes$}] \href{20260205161836-omologia_singolare_di_cw_complessi.org}{Omologia singolare di CW-complessi}
\item[{$\square$}] Calcolo esplicito della mappa di bordo per il complesso di catene cellulari: \href{20260205161912-complesso_di_catene_cellulari.org}{Complesso di catene cellulari}
\item[{$\square$}] \href{20250128132815-calcolo_dell_omologia_singolare_del_punto.org}{Calcolo dell'omologia singolare del toro}
\end{itemize}
\subsection{Lezione 18 [25\%]}
\label{sec:orge0f294a}

\begin{itemize}
\item[{$\square$}] \href{20260209174827-mappe_di_bordo_tra_moduli_di_catene_cellulari_dello_spazio_proiettivo_reale.org}{Mappe di bordo tra moduli di catene cellulari dello spazio proiettivo reale}
\item[{$\boxtimes$}] Proposizione sull'omologia singolare per CW-cpx: \href{20260205161836-omologia_singolare_di_cw_complessi.org}{Omologia singolare di CW-complessi}
\item[{$\square$}] \href{20260209161721-teorema_di_confronto_tra_omologia_singolare_e_simpliciale.org}{Teorema di Confronto tra omologia singolare e simpliciale}
\item[{$\square$}] \href{20260209161917-funtore_esatto.org}{Funtore esatto} e funtori derivati sinistri?
\end{itemize}
\subsection{Lezione 19 [0\%]}
\label{sec:org032c62d}

\begin{itemize}
\item[{$\square$}] \href{20260209161944-prodotto_tensoriale_di_moduli.org}{Prodotto tensoriale di moduli}
\item[{$\square$}] \href{20260209162059-funtore_prodotto_tensoriale.org}{Funtore prodotto tensoriale}
\item[{$\square$}] \href{20251201163733-gruppo_abeliano_graduato.org}{Modulo graduato}
\item[{$\square$}] \href{20260209162209-complesso_di_catene_come_modulo_graduato.org}{Complesso di catene come modulo graduato}
\item[{$\square$}] \href{20260209162236-prodotto_tensoriale_di_complessi_di_catene.org}{Prodotto tensoriale di complessi di catene}
\item[{$\square$}] Omologia del prodotto tensoriale di complessi di catene: \href{20260209162445-teorema_di_kunneth.org}{Teorema di Künneth}
\end{itemize}
\subsection{Lezione 20}
\label{sec:orgc96cf8c}

\begin{itemize}
\item[{$\square$}] \href{20260209162445-teorema_di_kunneth.org}{Teorema di Künneth}
\item[{$\square$}] \href{20260209162551-teorema_dei_coefficienti_universali.org}{Teorema dei coefficienti universali}
\end{itemize}
\end{document}
