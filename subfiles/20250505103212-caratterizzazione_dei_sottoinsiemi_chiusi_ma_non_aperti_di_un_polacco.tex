...
\section{Caratterizzazione dei sottoinsiemi chiusi ma non aperti di un polacco}
\label{sec:orgac334a1}
...
\paragraph{Non aperti sono \(\mathbf{\Pi}_{1}^{0}\)-hard\hfill{}\textsc{Modificato}}
...
e pertanto \(F(\beta)\notin A\).
\end{itemize}
\paragraph{Caratterizzazione dei chiusi ma non aperti}
