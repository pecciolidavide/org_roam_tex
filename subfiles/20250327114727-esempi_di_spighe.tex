...
\section{Esempi di spighe}
\label{sec:org86317d7}
\subsection{Spighe del fascio delle funzioni Cinfinito}
...
\subsection{Spighe del fascio localmente costante}
...
\end{prop}
\subsection{Spighe del fascio grattacielo}
...
\end{equation*}
\end{prop}
\subsection{Spieghe del fascio delle funzioni olomorfe}
