...
Allora esiste \(\delta\) tale che per ogni \href{20250103145124-topologia.org}{aperto} \(B\) in \(X\) di \href{20250327131547-diametro_di_un_insieme.org}{diametro} minore di \(\delta\), esiste \(U \in \mathcal{A}\) tale che \(B\subseteq U\).
\end{lem}
