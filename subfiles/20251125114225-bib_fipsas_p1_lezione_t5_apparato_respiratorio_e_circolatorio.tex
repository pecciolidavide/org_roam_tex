...
\section{(bib) FIPSAS - ``P1 - Lezione T5 - Apparato respiratorio e circolatorio''}
\label{sec:orgb0d8d2a}
\subsection{Approfondimento SLIDES}
\label{sec:orga97171a}

Approfondimento fatto tramite 
\subsubsection{Slide 1: FIPSAS - 1\textsuperscript{o} GRADO AR: ARGOMENTI DEL CORSO}
\label{sec:org69975b6}
\paragraph{Contenuto della Slide (Riepilogo)}
...
\paragraph{Approfondimento dal Manuale P1}
...
\subsubsection{Slide 2: CENNI DI ANATOMIA E FISIOLOGIA - Cellule (p. 71)}
\label{sec:orgb03b468}
\paragraph{Contenuto della Slide (Riepilogo)}
\label{sec:orga5a4e03}
...
\paragraph{Approfondimento dal Manuale P1 / Manuale Federale d’Immersione}
...
\subsubsection{Slide 3: CENNI DI ANATOMIA E FISIOLOGIA - Tessuti, Organi, Apparati}
\label{sec:org2c5dc5a}
\paragraph{Contenuto della Slide (Riepilogo)}
\label{sec:org85fe959}
...
\end{enumerate}
\subsubsection{Slide 4: APPARATO RESPIRATORIO - Funzione e Costituzione (p. 71)}
\label{sec:org7e71dc5}
\paragraph{Contenuto della Slide (Riepilogo)}
\label{sec:orgd4b0607}
...
\paragraph{Approfondimento dal Manuale Federale d’Immersione}
...
\subsubsection{Slide 5: APPARATO RESPIRATORIO - Vie Aeree Inferiori (Dettaglio)}
\label{sec:orga298e5e}
\paragraph{Contenuto della Slide (Riepilogo)}
\label{sec:org20af593}
...
\subsubsection{Slide 6: APPARATO RESPIRATORIO - Respirazione: Inspirazione (Fase attiva)}
\label{sec:orgc7e780d}
\paragraph{Contenuto della Slide (Riepilogo)}
\label{sec:org6496936}
...
\paragraph{Frequenza respiratoria media: 12-18 atti al minuto.}
\label{sec:org6f24376}
\paragraph{Volume di ventilazione totale: 7-8 litri al minuto.}
\label{sec:org1790568}
\paragraph{Approfondimento dal Manuale P1}
\label{sec:orgeb10b38}
...
\subsubsection{Slide 8: APPARATO RESPIRATORIO - Volumi e Capacità Polmonari}
\label{sec:orgc158dea}
\paragraph{Contenuto della Slide (Riepilogo)}
\label{sec:org5a43c0e}
\begin{itemize}
...
\subsubsection{Slide 9: APPARATO RESPIRATORIO - Composizione Aria e Ruolo dell'Azoto}
\label{sec:orgcdd9e3c}
\paragraph{Contenuto della Slide (Riepilogo)}
\label{sec:org8ea74ec}
\begin{itemize}
...
\end{itemize}
\subsubsection{Slide 10: APPARATO RESPIRATORIO - Respirazione in Immersione}
\label{sec:org1db7ee5}
\paragraph{Contenuto della Slide (Riepilogo)}
\label{sec:org70d9ba7}
...
\subsubsection{Slide 11: APPARATO CIRCOLATORIO - Funzione e Costituzione (p. 75)}
\label{sec:orge2d604b}
\paragraph{Contenuto della Slide (Riepilogo)}
\label{sec:orgbf3733a}
...
\subsubsection{Slide 12: APPARATO CIRCOLATORIO - Grande e Piccolo Circolo}
\label{sec:org34fb268}
\paragraph{Contenuto della Slide (Riepilogo)}
\label{sec:orgd36dae8}
\begin{enumerate}
...
\subsubsection{Appendice: Principi Fisici e Fisiologici Correlati al Contenuto delle Slide}
