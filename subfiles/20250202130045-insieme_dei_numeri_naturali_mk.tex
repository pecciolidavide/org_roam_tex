...
\section{Insieme dei numeri naturali}
\label{sec:orga7644a9}
\subsection{Principio di induzione}
\label{sec:orge56be82}
\subsection{Costruzione in MK}
\label{sec:org00ba3cb}

Contesto: \href{20250130104245-morse_kelly_set_theory.org}{Morse Kelly Set Theory}.
\subsubsection{Definizione\hfill{}\textsc{IdL:matematica\_lm}}
...
\end{enumerate}
\subsubsection{Induzione per i naturali}
