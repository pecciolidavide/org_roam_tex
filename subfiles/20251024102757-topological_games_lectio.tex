...
\section{Topological Games [LECTIO]}
\label{sec:org93e63ae}
\subsection{Giochi di Schmidt}
...
\subsubsection{Definizioni di TDI}
\label{sec:org69e5d46}

Un sottoinsieme \(Y\) di uno spaio topologico \(X\) è
\begin{itemize}
\item \uline{mai denso} in \(X\) se \(\operatorname{Int}(\operatorname{Cl}(Y)) = \emptyset\)
