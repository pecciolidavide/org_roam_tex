...
\section{Insieme ricorsivo}
\label{sec:org793f5e4}
...
\begin{definizione}
Un insieme \(P \subseteq \N^{k}\) è \texttt{ricorsivo} se la sua \href{20250215160218-funzione_caratteristica.org}{funzione caratteristica} \(\chi_{P} : \N^{k}\to \N\) è una \href{20250207104855-funzione_ricorsiva.org}{funzione ricorsiva}.
\end{definizione}
\begin{oss}
Un insieme \(P \subseteq \N^{k}\) è ricorsivo se e solo se \({\bm{J}}^{k}[P]\) è ricorsivo (vedi \href{20250215151413-biiezione_canonica_tra_n_e_n2.org}{Biiezione canonica tra N e prodotti cartesiani di N} e \href{20250202190147-immagine_punto_a_punto_di_due_classi.org}{Immagine punto a punto di due classi MK})
\end{oss}
\end{document}
