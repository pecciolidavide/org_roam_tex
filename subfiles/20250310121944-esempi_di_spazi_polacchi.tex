...
\section{Esempi di spazi polacchi}
\label{sec:orgff51b48}
\subsection{Il cubo di Hilbert è uno spazio polacco}
\label{sec:org0a50f38}
...
\subsection{Esercizi TDI - Foglio 1}
\label{sec:org8130bea}
\subsubsection{Esercizio 1}
\label{sec:orgdbfae09}
...
\end{itemize}
\begin{enumerate}
\item \(\operatorname{Tr}\) è chiuso in \(2^{(\omega^{<\omega})}\)
\label{sec:org7c05962}
...
\item \(\operatorname{PTr}\) è uno spazio polacco
\label{sec:org3dc8dca}
...
\item \(\operatorname{Tr}\setminus\operatorname{PTr}\) non è uno spazio polacco
\label{sec:org4174667}
...
la palla aperta.
\begin{enumerate}
\item \(\operatorname{Aut}(M)\) è uno spazio polacco
\label{sec:org743e996}
...
\end{itemize}
\item \(\operatorname{Aut}(M)\) è sottogruppo di \(S_{\infty}\)
\label{sec:org1fcdb5f}
...
\end{enumerate}
\paragraph{Soluzione}
\label{sec:org42acb58}

\begin{enumerate}
\item Parte a.
\label{sec:org0fc3845}
Posti:
\begin{align*}
