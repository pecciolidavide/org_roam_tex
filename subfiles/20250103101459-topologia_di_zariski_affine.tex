...
\section{Topologia di Zariski affine}
\label{sec:orgf4cb026}
...
\subsubsection{Dimostrazione che sia una topologia}
\label{sec:orgdb9b4ae}
\paragraph{Contiene \(\emptyset\) e \(\A^{n}\)}
\label{sec:orgf87421b}
Infatti, \(\emptyset=V(1)\) e \(\A^{n} = V(0)\).
\paragraph{Chiuso per intersezioni}
...
\end{equation*}
\paragraph{Chiuso per unioni finite}
