...
\paragraph{Classe Unione Generalizzata MK}
...
\end{equation*}
\subsubsection{Intersezione di classi MK}
...
Per l'Axiom of Extensionality, è commutativa.
\paragraph{Classe Intersezione Generalizzata}
...
\end{equation*}
e \(x\) è un insieme.
\subsubsection{Sottrazione di classi MK}
...
Per l'Axiom of Extensionality, è commutativa.
\subsubsection{Differenza simmetrica di classi MK}
