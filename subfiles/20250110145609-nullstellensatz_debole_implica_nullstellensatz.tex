...
\section{Nullstellensatz debole implica Nullstellensatz}
\label{sec:org3a3f6f9}
...
\subsection{Lemma di Rabinowitsch.}
...
\paragraph{\(I\left(V(J)\right) \subseteq \sqrt{J}\)}
...
\paragraph{\(\sqrt{J} \subseteq I\left(V(J)\right)\)}
