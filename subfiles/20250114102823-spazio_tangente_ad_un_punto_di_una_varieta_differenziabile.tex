...
\section{Spazio tangente ad un punto di una varietà differenziabile}
\label{sec:org6c9e9a4}
...
\subsection{Descrizione alternativa}
...
\subsubsection{Vettori dello spazio tangente ad una varietà in un punto come derivate di curve}
\label{sec:org26f4fb8}
\begin{prop}
Sia \(M\) una \href{20250113115909-struttura_differenziabile.org}{varietà differenziabile} e sia \(p \in M\). Sia \(\bm{v} \in \operatorname{T}_{p}M\) (vedi \hyperref[sec:org6c9e9a4]{Spazio tangente ad un punto di una varietà differenziabile}).
