...
\section{Sottospazio irriducibile}
\label{sec:org1d67410}
...
\paragraph{{\bfseries\sffamily TODO} Dimostrazione\hfill{}\textsc{matematica\_lm:geo\_alg}}
\label{sec:org3fc0bd9}
\end{document}
