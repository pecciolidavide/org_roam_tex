...
\section{STUDIARE}
\label{sec:org3499d2b}
\subsection{Metodo di studio proposto}
\label{sec:org309bf66}
\subsubsection{Struttura giornaliera in blocchi Pomodoro (50/10)}
...
\end{itemize}
\subsubsection{Giorni full-focus}
\label{sec:orgf85d04f}
\begin{itemize}
\item Sessioni dedicate esclusivamente a esercizi e recall
\end{itemize}
\subsection{Criticità e ottimizzazioni}
\label{sec:orgef7e159}

\subsubsection{Equilibrio e stanchezza}
\label{sec:org95c5c52}

\begin{itemize}
\item \textbf{Rischio}: calo di attenzione nel blocco tardo pomeriggio di 2 ore continue
\item \textbf{Soluzione}: spezzare in 2 per 40–50 min con pause attive
\end{itemize}
\subsubsection{Spaced repetition integrata}
...
\end{itemize}
\subsubsection{Micro-obiettivi e transizioni}
