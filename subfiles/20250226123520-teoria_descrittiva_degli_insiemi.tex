...
\section{Teoria descrittiva degli insiemi [CORSO]}
\label{sec:org2d41c54}
...
\end{itemize}
\subsection{{\bfseries\sffamily DONE} Esercizi}
\label{sec:orgc7e27a2}

\subsubsection{Foglio di esercizi 1}
...
\subsubsection{Foglio di esercizi 2}
...
\subsubsection{Foglio di esercizi 3}
...
\end{itemize}
\subsubsection{Foglio di esercizi 4}
...
\end{itemize}
\subsubsection{Foglio di esercizi 5}
