...
tale che:
\begin{itemize}
\item \(X_{0}\) è \href{20260128123515-sottoinsieme_discreto.org}{discreto};
\item per ogni \(k\): esiste una famiglia \(\set{e_{\alpha}^{k+1}}_{\alpha \in A^{k+1}}\) di \href{20250215122759-export.org_archive}{\((k+1)\)-celle} ed una famiglia di funzioni \href{20250103103252-funzione_continua.org}{continue} dal \href{20250129161026-bordo.org}{bordo} \(\varphi_{\alpha}^{k+1}: \partial e_{\alpha}^{k+1} \to X_{k}\); tali che \(X_{k+1}\) sia dato dal \href{20250215122759-export.org_archive}{seguente attaccamento}:
\begin{equation*}
