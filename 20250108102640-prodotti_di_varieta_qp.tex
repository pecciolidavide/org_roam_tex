...
\date{\today}
\title{Prodotti di varietà QP}
\begin{document}

Sia \(\K\) un \href{20241231112713-campo_algebricamente_chiuso.org}{campo algebricamente chiuso}.
\section{Caso \href{20241231115051-spazio_proiettivo.org}{proiettivo}}
\label{sec:orgf97faad}
...
\end{equation*}
\paragraph{Esistenza di \(H\)}
\label{sec:orgece847c}
Si definisce
\begin{align*}
...
che è un morfismo.
\end{itemize}
\paragraph{Unicità di H}
\label{sec:org7404f94}
