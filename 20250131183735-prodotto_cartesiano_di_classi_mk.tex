...
\date{\today}
\title{Prodotto cartesiano}
\begin{document}

\section{Generalizzazione in MK}
\label{sec:orgc152a35}
...
\subsection{MK Prodotto di insiemi è un insieme}
\label{sec:org5e32eeb}
...
\section{Prodotto cartesiano generalizzato}
\label{sec:orgf152f54}
...
\subsection{Potenza di una classe}
\label{sec:orga2a7afa}
...
X^{3}, X^{4},\text{etc.}
\end{equation*}
in quanto \(X^{3}=X\times(X\times X)\) o \(X^{3}= (X\times X) \times X\)? Infatti, il \href{20250131183735-prodotto_cartesiano_di_classi_mk.org}{prodotto cartesiano} non è commutativo.

Si sfrutta quindi la definizione di \hyperref[sec:orgf152f54]{prodotto cartesiano generalizzato}, e si pone\footnote{Vedi: \href{20250206170922-sequenze_e_stringhe.org}{Stringa} e \href{20250202192030-classe_delle_classi_funzioni.org}{Insieme delle funzioni}}
\begin{equation*}
