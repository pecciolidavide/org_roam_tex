...
\date{\today}
\title{Immersione Subacquea ricreativa}
\begin{document}

\section{Pianificazione dell'immersione}
\label{sec:orgcf0fa53}
\href{20250515141706-da_finire.org}{DA FINIRE}
\section{Briefing}
\label{sec:org14e856e}
\subsection{Briefing}
\label{sec:orgcd479ad}
...
\end{itemize}
\subsubsection{Migliorie da implementare}
\label{sec:org39b3074}
...
\end{itemize}
\section{Gestione dell'immersione da istruttore}
\label{sec:orga03db84}
Alcuni suggerimenti da tenere a mente, di validità generale:
\subsection{Comfort degli allievi}
\label{sec:org14741c7}

\begin{itemize}
\item In Acqua, fare quanto dichiarato nel briefing.
\end{itemize}
\subsection{Sicurezza}
\label{sec:org26a58ce}
...
\end{itemize}
\subsection{Altri consigli}
\label{sec:orgd877ab1}
