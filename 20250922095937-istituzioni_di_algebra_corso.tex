...
\date{\today}
\title{Istituzioni di Algebra [CORSO]}
\begin{document}

\maketitle
\tableofcontents\newpage
\section{Introduzione}
\label{sec:org8c4ff7e}
...
\uline{Libro di Testo}: Atiyah - Macdonald, \emph{Introduzione all'algebra commutativa}. \autocite{atiyahIntroductionCommutativeAlgebra1994}\footnote{\url{https://webhomes.maths.ed.ac.uk/\~v1ranick/papers/AtiyahMacdonald.pdf}}

La Terracini seguira pedissequamente il libro, quindi non metterà note.
\newpage
\part{Algebra commutativa di base}
\section{Lezione 1 - \textit{<2025-09-22 Mon>}}
\label{sec:org81e8624}

\subsection{Anelli e ideali}
\label{sec:orga970262}
...
\end{oss}
\subsubsection{Ideali in un anello quoziente}
\label{sec:orgb4e9634}
...
\end{align*}
\end{esempio}
\section{Lezione 2 - \textit{<2025-09-23 Tue>}}
\label{sec:org47b759e}
\subsubsection{Domini di integrità}
\label{sec:orge2bdfaa}
...
\end{proof}
\subsubsection{Ideali primi e massimali}
\label{sec:org047fb99}
...
\end{equation*}
\end{esempio}
\subsubsection{Nilradicale e Radicale di Jacobson}
\label{sec:org7554e1f}
...
\end{proof}
\section{Lezione 3 - \textit{<2025-09-29 Mon>}}
\label{sec:orgd5faae1}
...
Pertanto \(1-xy \notin A^{\times}\).
\end{proof}
\subsubsection{Operazioni sugli ideali}
\label{sec:org02ecaa6}
...
\end{equation*}
\end{oss}
\subsubsection{Prodotto diretto di Anelli}
\label{sec:orgf1ad562}
...
\end{oss}
\subsubsection{Proprietà di evitamento (\emph{avoidance}) e assorbimento (\emph{absorbance}) degli ideali primi}
\label{sec:orgf5a5391}
...
\end{enumerate}
\end{proof}
\subsubsection{Quoziente di Ideali}
\label{sec:org2496bdc}
...
\label{sec:orgce0fcb8}
\subsubsection{Contrazione ed estensione di ideali}
\label{sec:orgc6724ce}
...
\end{itemize}
\end{esempio}
\subsection{Spec di un anello [Parentesi estemporanea fuori programma]}
\label{sec:orgaf699ee}
...
\end{align*}
\end{definizione}
\section{Lezione 5 - \textit{<2025-10-06 Mon>}}
\label{sec:org63a363e}
...
\end{align*}
\end{oss}
\subsubsection{Sottomoduli}
\label{sec:org28e7830}
...
\end{oss}
\subsubsection{Modulo quoziente}
\label{sec:org89a4c38}
\begin{definizione}
...
\end{esempio}
\subsubsection{Operazioni sui sottomoduli}
\label{sec:org6c1ea45}
...
\end{proof}
\subsubsection{Somma diretta e prodotto diretto}
\label{sec:orga7bb323}
...
\end{prop}
\subsubsection{Caratteristica dei moduli liberi}
\label{sec:org6f15e20}
...
\end{oss}
\section{Lezione 6 - \textit{<2025-10-07 Tue>}}
\label{sec:org70fc83a}

\subsubsection{Caratteristica dei moduli liberi}
\label{sec:org03deb1f}
...
\end{oss}
\subsubsection{Proprietà degli \(A\)-moduli f.g.}
\label{sec:org28ef31d}
...
\end{proof}
\subsubsection{Successioni esatte}
\label{sec:orgf4308a9}
...
\end{equation*}
\end{esempio}
\subsubsection{Problema dell'esattezza di un funtore}
\label{sec:org2e59fe5}
...
\end{proof}
\section{Lezione 7 - \textit{<2025-10-10 Fri>}}
\label{sec:orgbb97732}
...
\end{equation*}
\end{proof}
\subsection{Prodotto tensoriale di \(A\)-moduli}
\label{sec:org8c14d08}
...
\end{proof}
\subsection{Estensione e restrizione degli Scalari}
\label{sec:org79c20be}

\subsubsection{Spazi Vettoriali}
\label{sec:org9fa0261}
...
\end{align*}
\end{itemize}
\subsubsection{Caso Generale: Moduli e Algebre}
\label{sec:orgf895317}
...
\end{itemize}
\section{Lezione 8 - \textit{<2025-10-13 Mon>}}
\label{sec:org9871d7c}

\subsection{Prodotto tensoriale}
\label{sec:org2db10f5}
...
\end{equation*}
\end{prop}
\subsection{Proprietà del prodotto tensoriale}
\label{sec:org11b1fe3}
...
\end{oss}
\subsection{Moduli Piatti}
\label{sec:orgb597d43}
...
\end{itemize}
\end{esempio}
\subsection{Limite Diretto (Iniettivo)}
\label{sec:org186146f}
...
\end{quote}
\subsubsection{Costruzione di \(\tilde{M}\):}
\label{sec:org0e3d39e}
...
\end{equation*}
\subsubsection{Limite diretto e prodotto tensoriale}
\label{sec:orgd951b0f}
...
\end{enumerate}
\end{proof}
\subsection{Limite Inverso (Proiettivo)}
\label{sec:orga755eda}
...
\subsubsection{Costruzione di \(\overline{M}\):}
\label{sec:org5e8c6cd}
...
\end{esempio}
\subsubsection{Limiti inversi e prodotto tensoriale}
\label{sec:org3f01fcc}
...
\end{esempio}
\section{Lezione 9 - \textit{<2025-10-14 Tue>}}
\label{sec:org406340d}
\subsection{Anelli e Moduli di Frazioni}
\label{sec:org92e4655}
\subsubsection{Anelli di frazioni}
\label{sec:org63a04c9}
...
\end{itemize}
\end{esempio}
\subsubsection{Ideali dell'anello di frazioni}
\label{sec:org19bd238}
...
\subsubsection{Localizzazione come limite iniettivo}
\label{sec:org2e2c5c2}
...
????? Finire
\section{Lezione 10 - \textit{<2025-10-17 Fri>}}
\label{sec:org888721d}
...
\end{equation*}
\end{esempio}
\subsubsection{Localizzazione di moduli}
\label{sec:org40fc8ff}
...
\end{proof}
\subsubsection{Localizzazione e prodotto tensoriale}
\label{sec:org5ce8ba7}
...
\end{equation*}
\subsubsection{Proprietà locali}
\label{sec:orgd7d3cf8}
...
\end{esempio}
\section{Lezione 11 - \textit{<2025-10-20 Mon>}}
\label{sec:orgf70b2fe}
...
è esatta.
\end{proof}
\subsection{Decomposizione primaria di ideali}
\label{sec:org3fd8cde}
...
\end{proof}
\begin{esempio}
Esempi 2) e 3) di \autocite{atiyahIntroductionCommutativeAlgebra1994} a pag. 51
\end{esempio}
...
\end{thm}
\begin{proof}
Vedi dimostrazione del Teorema~4.5 di \autocite{atiyahIntroductionCommutativeAlgebra1994}.
\end{proof}
\section{Lezione 12 - \textit{<2025-10-21 Tue>}}
\label{sec:org0792d21}
...
\section{Lezione 13 - \textit{<2025-10-24 Fri>}}
\label{sec:org4d090b9}

Lei segue \autocite{sharpStepsCommutativeAlgebra2000}
\subsection{Condizioni Catenarie (Noetherianità - Artinianità)}
\label{sec:org0dd02a0}
...
\end{proof}
\subsection{Moduli e Anelli Noetheriani e Artiniani}
\label{sec:orga6f7dba}
...
\end{proof}
\subsection{Caratterizzazione dei Moduli Noetheriani}
\label{sec:org1aa4e4a}
...
\end{proof}
\section{Lezione 14 - \textit{<2025-10-27 Mon>}}
\label{sec:orgec1537f}
...
\end{oss}
\section{Lezione 15 - \textit{<2025-10-28 Tue>}}
\label{sec:orgbe8e611}
...
\end{itemize}
\end{proof}
\section{Lezione 16 - \textit{<2025-10-31 Fri>}}
\label{sec:org5825986}
...
\end{esempio}
\section{Lezione 17 - \textit{<2025-11-03 Mon>}}
\label{sec:orga16f37c}
...
\end{equation*}
\end{proof}
\subsection{Teorema della base di Hilbert}
\label{sec:org0cb1e78}
...
\end{esempio}
\subsubsection{\(A\)-algebre}
\label{sec:org18c26ac}
...
\end{oss}
\section{Lezione 18 - \textit{<2025-11-04 Tue>}}
\label{sec:org3475275}
...
\end{proof}
\subsection{Sottoanelli e Noetherianità}
\label{sec:org6332f71}
...
\end{itemize}
\subsection{Divisori dello Zero e Decomposizione Primaria}
\label{sec:orgf561746}
...
\end{equation*}
\end{proof}
\section{Lezione 19 - \textit{<2025-11-07 Fri>}}
\label{sec:orgd3733d7}
...
Assurdo.
\end{proof}
\section{Lezione 20 - \textit{<2025-11-10 Mon>}}
\label{sec:orgdea0283}

\subsection{Teoremi su Anelli Artiniani e Noetheriani}
\label{sec:orgef7d8d1}
...
\subsection{Teorema di Struttura di Moduli su PID}
\label{sec:org5027313}
...
\section{Lezione 21 - \textit{<2025-11-11 Tue>}}
\label{sec:org6ab7ab8}
...
\lipsum[1].
\end{proof}
\section{Lezione 22 - \textit{<2025-11-14 Fri>}}
\label{sec:org9e72567}

\subsection{Forma canonica di Jordan}
\label{sec:org7340124}
...
\end{esempio}
\section{Lezione 23 - \textit{<2025-11-17 Mon>}}
\label{sec:orgf7bbfa3}

\subsection{Dipendenza Integrale}
\label{sec:orgb237878}
...
\end{definizione}
\subsection{Caratterizzazioni della Dipendenza Integrale}
\label{sec:org8b8bce6}
...
\end{itemize}
\end{proof}
\subsection{Chiusura Integrale}
\label{sec:org5a64ce3}
...
\end{proof}
\subsection{Comportamento con Quozienti e Localizzazioni}
\label{sec:orgd367ecc}
...
\end{itemize}
\end{proof}
\section{Lezione 24 - \textit{<2025-11-18 Tue>}}
\label{sec:orgbefdcf8}
...
\section{Lezione 25 - \textit{<2025-11-21 Fri>}}
\label{sec:org181ac67}
...
\end{proof}
\section{Lezione 26 - \textit{<2025-11-24 Mon>}}
\label{sec:orgac4dbb8}
...
\end{definizione}
\subsection{Monomoduli}
\label{sec:orgd9c64ce}
...
\end{esempio}
\subsubsection{\emph{Term order}}
\label{sec:org9786ffd}
...
\end{equation*}
\end{itemize}
\section{Lezione 27 - \textit{<2025-11-25 Tue>}}
\label{sec:org2c2f51c}
...
\subsection{Divisioni in \(\K[X_{1},\dots,X_{n}]\)}
\label{sec:orgc213684}
...
\end{quote}
\end{esempio}
\section{Lezione 28 - \textit{<2025-11-28 Fri>}}
\label{sec:orgeaea7f1}

\subsection{Divisione con Resto con Term Order}
\label{sec:org8b20aa5}
...
\end{equation*}
\end{proof}
\subsection{Problema dell'Appartenenza Ideale (Ideal Membership Problem)}
\label{sec:orgce05f39}
...
\subsection{Base di Gröbner}
\label{sec:org005245c}
...
\end{oss}
\section{Lezione 29 - \textit{<2025-12-01 Mon>}}
\label{sec:orgbe45a1b}

\subsection{Module Membership Problem}
\label{sec:orgdfd5332}
...
e pertanto \(m \in M\).
\end{proof}
\subsection{Esistenza della Base di Groebner}
\label{sec:org888a6e1}
...
\end{oss}
\subsection{Basi di Groebner ridotte}
\label{sec:orge24b5dd}
...
\label{sec:orge304e29}

\subsection{Criterio di Buchberger}
\label{sec:org96e814a}
...
\end{algorithmic}
\end{algorithm}
\section{Lezione 31 - \textit{<2025-12-05 Fri>}}
\label{sec:orgbea67bd}
...
\end{enumerate}
\subsection{Teorema di Eliminazione}
\label{sec:orga4a9d3a}
...
\end{oss}
\section{Lezione 32 - \textit{<2025-12-09 Tue>}}
\label{sec:orgfe36190}
...
\end{oss}
\section{Lezione 33 - \textit{<2025-12-15 Mon>}}
\label{sec:orgaa43a97}
...
\end{esempio}
\subsection{Applicazioni alla Geometria Algebrica}
\label{sec:org3fc5120}
...
\end{equation*}
\end{esempio}
\subsection{Nullstellensatz di Hilbert}
\label{sec:org449675e}
...
\end{equation*}
\end{esempio}
\section{{\bfseries\sffamily TODO} Lezione 34 - \textit{<2025-12-16 Tue>}}
\label{sec:org07453b7}

???
\section{Lezione 35 - \textit{<2025-12-17 Wed>}}
\label{sec:org4abdd7a}
...
\end{proof}
\subsection{Algoritmo di calcolo intersezioni di ideali}
\label{sec:org1d56eb3}

\textbf{\textbf{MANCA UN PEZZO}} (ma dovrebbe caricare le sue note)
\subsection{Calcolo del minimo comune multiplo}
\label{sec:org54aaa0f}
...
\end{itemize}
\subsection{Colon tra ideali}
\label{sec:org4ca2b5b}
...
\end{esempio}
\section{Lezione 36 - \textit{<2025-12-19 Fri>}}
\label{sec:orgd269549}

\subsection{Automatic Geometric Theorem Proving}
\label{sec:org792ad97}
...
L'esempio di prima è l'Esempio 1 di pagine 319 di \autocite{coxIdealsVarietiesAlgorithms2015}
...
L'esempio di prima è tratto da \autocite{coxIdealsVarietiesAlgorithms2015}
\subsection{Colorazione dei grafi}
\label{sec:org6f6bcc1}
