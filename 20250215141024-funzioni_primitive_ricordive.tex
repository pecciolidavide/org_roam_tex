...
\date{\today}
\title{Funzioni primitive ricorsive}
\begin{document}
...
\label{sec:orge196930}
Sono \hyperref[sec:org2eb8448]{funzioni ricorsive ricorsive} le seguenti:
\begin{itemize}
