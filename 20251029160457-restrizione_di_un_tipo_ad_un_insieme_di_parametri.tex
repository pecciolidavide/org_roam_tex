...
\mathrel{\nonforkSymbol_{#1}}}
\section{Restrizione di un tipo ad un insieme di parametri}
\label{sec:org6e4c195}
...
Se \(p(x) \subseteq \L(\U)\) è un tipo, con \(p(x) \upharpoonright {\footnotesize A}\) si intende
\begin{equation*}
p(x) \upharpoonright {\footnotesize A} \coloneqq p(x) \cap \mathcal{L}(A)
\end{equation*}
\end{document}
