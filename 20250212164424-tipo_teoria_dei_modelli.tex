...
\section{Soddisfazione di un tipo}
\label{sec:org070e05f}
...
\section{Tipo soddisfacibile}
\label{sec:org1009c80}
\begin{itemize}
...
\end{itemize}
\section{Tipo finitamente soddisfacibile}
\label{sec:orgb33d4a3}
\begin{itemize}
...
\end{itemize}
\section{Tipo di un elemento di una struttura}
\label{sec:org5154062}
...
\end{equation*}
\subsection{Tuple elementarmente equivalenti su un insieme di parametri}
\label{sec:org6c67dfd}
\begin{definizione}
...
\end{equation*}
\end{definizione}
\section{Insieme definito da un tipo}
\label{sec:orge415dff}
