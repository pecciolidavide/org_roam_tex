...
\subsection{Gioco Logico totale}
\label{sec:orgbb203dd}
Un gioco è detto \uline{totale} se \(\Omega^{\omega} \subseteq W_{\text{I}}\cup W_{\text{II}}\).
\subsection{Strategia per un gioco logico}
\label{sec:org829ef2f}
