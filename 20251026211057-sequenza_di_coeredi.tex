...
LSASE:
\begin{enumerate}
\item \(\overline{c} = \langle c_{i} : i<\omega \rangle\) è \hyperref[sec:org361a1b7]{sequenza di coeredi su \(M\)} (rispetto a qualche \(p(x) \in S(\U)\)\footnote{Con \(S(\U)\) si intende l'insieme dei tipi globali (notazione propria del \href{20250617102733-modello_mostro.org}{Modello MOSTRO})});
