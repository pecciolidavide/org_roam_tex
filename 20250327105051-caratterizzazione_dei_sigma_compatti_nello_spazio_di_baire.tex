...
\date{\today}
\title{Caratterizzazione dei sigma-compatti nello spazio di Baire}
\begin{document}

\section{Proposizione}
\label{sec:orgc8f8e4a}
...
\label{sec:orgd26a8b0}

\subsubsection{b. implica a.}
\label{sec:org58faab2}
...
\item è \href{20250327104804-insieme_limitato_dello_spazio_di_baire.org}{definitivamente limitato} per la dimostrazione ``\ref{sec:orgbda5d95}'' svolta sopra.
\end{itemize}
