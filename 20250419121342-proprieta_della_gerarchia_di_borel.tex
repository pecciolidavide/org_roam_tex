...
\date{\today}
\title{Proprietà della gerarchia di Borel}
\begin{document}

\section{Proposizione}
\label{sec:orgb80cb92}
...
\label{sec:org1ebf2e4}

\subsubsection{Caso base: \(\alpha=1\)}
\label{sec:org98c8307}
...
\label{sec:orgaedfb78}

Sia l'enunciato vero per ogni \(\beta<\alpha\).
\paragraph{Classi additive}
\label{sec:orgd84441c}
...
\end{itemize}
\paragraph{Classi moltiplicative}
\label{sec:org66bf6de}
...
\end{equation*}
\end{itemize}
\paragraph{Classi ambigue}
\label{sec:org53576c8}
