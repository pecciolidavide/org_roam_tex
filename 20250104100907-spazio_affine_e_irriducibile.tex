...
\subsubsection{Claim: \(I(\A^{n})=(0)\).}
\label{sec:org9241b0f}
...
\paragraph{Caso base: \(n=1\)}
\label{sec:orgd812f7d}
...
\end{equation*}
\subsubsection{Claim: \((0)\) è un ideale primo}
\label{sec:orgbe0d355}
