...
\date{\today}
\title{Esempi fondamentali di varietà topologiche}
\begin{document}

\section{Rn è una varietà topologica}
\label{sec:orgd429bde}
...
\section{Aperti di Rn sono varietà topologica}
\label{sec:org87db4b7}
