...
\date{\today}
\title{K-Algebre fin generate e ridotte come anelli delle coordinate di varietà affini}
\begin{document}

Sia \(\K\) un \href{20241231112713-campo_algebricamente_chiuso.org}{campo algebricamente chiuso}.
\section{Teorema}
\label{sec:org29f5e57}
...
\label{sec:org76c67ca}

\subsubsection{{\bfseries\sffamily TODO} Implicazione <-\hfill{}\textsc{matematica\_lm:geo\_alg}}
\label{sec:orga6d883f}
