...
\label{sec:org13ff52c}
\begin{definizione}
Sia \(X\) uno \href{20250103145124-topologia.org}{spazio topologico} e \(\mathcal{F}\) un \href{20250324165349-prefascio.org}{prefascio}. Il \hyperref[sec:org479f24a]{morfismo} identità \(\Id_{\mathcal{F}}: \mathcal{F}\to \mathcal{F}\) è, per ogni \(U \subseteq X\) aperto, \((\Id_{\mathcal{F}})_{U} \coloneqq \Id_{U}\)\footnote{\(\Id_{U}\) è la \href{20250310111151-funzione_identita.org}{Funzione identità}.}.
\end{definizione}
\subsection{Composizione di morfismi di prefasci}
\label{sec:orga77ea0e}
\begin{definizione}
...
\end{align*}
due \hyperref[sec:org479f24a]{morfismi di prefasci}. Per ogni \(U \subseteq X\) aperto si hanno i \href{20241126100904-categoria.org}{morfismi}
\begin{equation*}
\begin{tikzcd}[ampersand replacement=\&,cramped]
...
Questo definisce un \hyperref[sec:org479f24a]{morfismo} \(g\circ f: \mathcal{F}\to \mathcal{H}\).
\end{definizione}
\subsection{Isomorfismo di prefasci}
\label{sec:org0bca82e}
\begin{definizione}
Sia \(X\) uno \href{20250103145124-topologia.org}{spazio topologico} e siano \(\mathcal{F},\mathcal{G}\) due \href{20250324165349-prefascio.org}{prefasci}. Un \hyperref[sec:org479f24a]{morfismo} \(f:\mathcal{F}\to \mathcal{G}\) è detto \uline{isomorfismo} se esiste un \hyperref[sec:org479f24a]{morfismo} \(g:\mathcal{G}\to \mathcal{F}\) tale che\footnote{Vedi:
\begin{itemize}
\item \hyperref[sec:orga77ea0e]{Composizione di morfismi di prefasci}
\item \hyperref[sec:org13ff52c]{Morfismo identità tra prefasci}
\end{itemize}}
\begin{equation*}
...
\begin{prop}
Un \hyperref[sec:org15d319f]{morfismo} di (\hyperref[sec:org479f24a]{pre})\hyperref[sec:org15d319f]{fasci} \(f:\mathcal{F}\to\mathcal{G}\) è un \hyperref[sec:org0bca82e]{isomorfismo}  se e solo se per ogni \(U \subseteq X\) \href{20250103145124-topologia.org}{aperto}, \(f_{U} : \mathcal{F}(U)\to \mathcal{G}(U)\) è un \href{20241128162125-isomorfismo.org}{isomorfismo}.
\end{prop}
\section{Morfismo di fasci}
\label{sec:org15d319f}
\begin{definizione}
Se \(\mathcal{F}\) e \(\mathcal{G}\) sono due fasci, un \uline{morfismo di fasci} \(f:\mathcal{F}\to \mathcal{G}\) è il \hyperref[sec:org479f24a]{morfismo tra prefasci} \(f:\mathcal{F}\to \mathcal{G}\).
\end{definizione}
\end{document}
