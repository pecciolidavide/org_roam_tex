...
Il morfismo somma diretta, denotato con \(\bigoplus_{\alpha \in I} F_{\bullet}^{\alpha}\), è la mappa tra le \hyperref[sec:orgcd8178e]{somme dirette dei complessi}:
\begin{equation*}
