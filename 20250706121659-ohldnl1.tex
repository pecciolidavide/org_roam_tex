...
\end{equation*}
Si vedano ``\href{20250624162220-spazi_lp.org}{Spazi Lp}''\label{orga51c74b}}.
\label{prop9.3.17}
\end{prop}
...
\end{equation*}
è \href{20250301193045-sottoinsieme_denso.org}{denso} in \(L^{1}(I_{n})\)\textsuperscript{\ref{orga51c74b}}.
\label{thm9.3.18}
\end{cor}
\end{document}
