...
\date{\today}
\title{Scomposizione di sp top noetheriani in componenti irriducibili}
\begin{document}

\section{Teorema}
\label{sec:org001c638}
...
\label{sec:orga93f4dd}

\subsubsection{Esistenza}
\label{sec:org2e6d591}
...
\subsubsection{{\bfseries\sffamily TODO} Unicità\hfill{}\textsc{matematica\_lm:geo\_alg}}
\label{sec:org88bdb7c}
Siano
\begin{equation*}
