...
\date{\today}
\title{Caratterizzazione dei sottoinsiemi polacchi di uno spazio polacco}
\begin{document}

\section{Teorema}
\label{sec:org1d952af}
...
\label{sec:orgd15be4a}
\subsubsection{2. -> 1.}
\label{sec:orge030546}
