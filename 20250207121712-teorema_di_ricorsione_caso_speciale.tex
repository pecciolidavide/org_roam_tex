...
\date{\today}
\title{Teorema di Ricorsione - caso speciale}
\begin{document}
...
\subsubsection{Costruzione della funzione G}
\label{sec:org7ae5584}
...
\subsubsection{Si deve dimostrare che è una funzione totale.}
\label{sec:org063315c}
...
\subsubsection{Unicità della funzione G}
\label{sec:org8538643}
