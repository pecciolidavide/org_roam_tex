...
\date{\today}
\title{Coppia ordinata}
\begin{document}

\section{Formalizzazione in MK}
\label{sec:org6cec0ec}

Contesto: \href{20250130104245-morse_kelly_set_theory.org}{Morse Kelly Set Theory}
\subsection{Coppia ordinata di insiemi (Kuratowski)}
\label{sec:org6fdb64b}
...
\subsection{Coppia ordinata di classi}
\label{sec:org45c29ae}
