...
\date{\today}
\title{Classe Transitiva}
\begin{document}

Contesto: \href{20250130104245-morse_kelly_set_theory.org}{Morse Kelly Set Theory}
\section{Definizione}
\label{sec:org7d0eb5a}
...
\label{sec:org0e79b9b}

\subsubsection{Unione generalizzata}
\label{sec:orgfdb51e5}
Si ha che
\begin{equation*}
