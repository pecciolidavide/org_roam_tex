...
\label{sec:orga826fff}
Sia \(L\) un \href{20250130162057-linguaggio_del_prim_ordine.org}{linguaggio} \href{20250111143651-insieme_numerabile.org}{numerabile}; una \(L\)-\hyperref[sec:orga826fff]{teoria} \(T\) si dice \uline{decidibile} se \(\operatorname{Teor}_{T}^{\#} \subseteq \N\) è \href{20250216173925-insieme_ricorsivo.org}{ricorsivo}.

In caso contrario, \(T\) si dice \uline{indecidibile}
\section{Teoria decidibile è ricorsivamente assiomatizzabile}
\label{sec:org0a60171}
