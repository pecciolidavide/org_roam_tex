...
\date{\today}
\title{Proiezione su un iperpiano dentro allo spazio proiettivo}
\begin{document}
...
\section{{\bfseries\sffamily TODO} Proiezione da uno spazio lineare\hfill{}\textsc{matematica\_lm:geo\_alg}}
\label{sec:org99865fe}
\end{document}
