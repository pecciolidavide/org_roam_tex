...
\date{\today}
\title{Oscillazione di una funzione in uno spazio metrico}
\begin{document}
...
\section{Insieme dei punti in cui l'oscillazione di una funzione si annulla}
\label{sec:orgce483a0}
\subsection{Continuità}
\label{sec:org44b409b}
...
\subsection{Insieme \(G_{\delta}\)}
\label{sec:org744c297}
...
\subsection{L'insieme dei punti di continuità di una funzione continua in uno spazio metrizzabile è Gdelta}
\label{sec:org0df2f99}
