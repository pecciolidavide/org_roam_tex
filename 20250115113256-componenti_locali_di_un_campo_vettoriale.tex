...
\date{\today}
\title{Componenti locali di un campo vettoriale}
\begin{document}
...
\section{{\bfseries\sffamily TODO} Scrittura come \(X=X^{r}\pd{}{{x^{r}}}\)\hfill{}\textsc{matematica\_lm:geo\_diff}}
\label{sec:org08e1af2}
\end{document}
