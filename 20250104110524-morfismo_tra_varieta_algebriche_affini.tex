...
\date{\today}
\title{Morfismo tra varietà algebriche affini}
\begin{document}
...
\section{Isomorfismo tra varietà algebriche affini}
\label{sec:org9ab02db}
\subsection{Definizione}
\label{sec:org11d8ac6}
...
\end{itemize}
\section{Esempi di morfismi}
\label{sec:org019051e}

\subsection{Esempio 1}
\label{sec:org2b70d9f}
...
Dunque \(F\) è un \hyperref[sec:org9ab02db]{isomorfismo}.
\end{document}
