...
\date{\today}
\title{Estensione di una funzione continua ad un dominio Gdelta}
\begin{document}

\section{Teorema}
\label{sec:orgefbceaa}
...
\subsubsection{Definizione insieme \(G\)}
\label{sec:org9075400}
Si ponga
\begin{equation*}
...
\end{equation*}
\subsubsection{Definizione funzione \(g\)}
\label{sec:orgc1633b1}
...
\end{equation*}
\paragraph{Buona definizione}
\label{sec:org01d819b}
