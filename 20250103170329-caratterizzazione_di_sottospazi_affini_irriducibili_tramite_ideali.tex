...
\date{\today}
\title{Caratterizzazione di sottospazi affini irriducibili tramite ideali}
\begin{document}

Sia \(\K\) un \href{20241231112713-campo_algebricamente_chiuso.org}{campo algebricamente chiuso}.
\section{Teorema}
\label{sec:org6093c87}
...
\label{sec:org269f293}

\subsubsection{``\(\implies\)''}
\label{sec:org186c7c4}
