...
\date{\today}
\title{Insieme dei campi vettoriali come spazio vettoriale reale e come modulo}
\begin{document}
...
\subsection{{\bfseries\sffamily {[}?]} Dimostrazione\hfill{}\textsc{matematica\_lm:geo\_diff}}
\label{sec:org3483af0}
