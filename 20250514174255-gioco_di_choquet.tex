...
\date{\today}
\title{Gioco di Choquet}
\begin{document}

\section{Gioco di Choquet}
\label{sec:orgf9aecd7}
...
\label{sec:org893da20}
\subsection{Teorema}
\label{sec:org469c50b}

Uno \href{20250103145124-topologia.org}{spazio topologico} \(X\) è uno \href{20250514154101-spazio_topologico_di_baire.org}{spazio topologico di Baire} se e solo se il giocatore I \uline{non ha una \href{20250513171520-giochi_di_gale_stewart.org}{strategia} \href{20250513171520-giochi_di_gale_stewart.org}{vincente}} nel \hyperref[sec:orgf9aecd7]{gioco di Choquet} \(G_{X}\).
\subsection{Spazio di Choquet}
\label{sec:orgd29ea01}
\subsubsection{Definizione}
\label{sec:orgf291690}

Uno spazio topologico \(X\) è detto \uline{spazio di Choquet} se il giocatore II ha una strategia vincente in \(G_{X}\).
\subsubsection{Osservazione}
\label{sec:org71e1ccd}
