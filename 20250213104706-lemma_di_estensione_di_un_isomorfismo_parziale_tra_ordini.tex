...
\date{\today}
\title{Lemma di estensione di un isomorfismo parziale tra ordini}
\begin{document}
...
\label{sec:org7287ec6}
\subsubsection{Caso 1}
\label{sec:org2799f9e}
Se \(b \in \dom k\) allora \(h=k\) è la funzione cercata.
\subsubsection{Caso 2}
\label{sec:org6c6ea88}
